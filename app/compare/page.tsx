...
import TranscriptList from '../symbol/[id]/transcriptslist'
...
export default function ComparePage() {
  ...
  return (
    <>
      <div className="flex h-[100vh] w-full items-center gap-2 bg-gray-100 p-2 text-slate-600">
        ...
        <FixedHeightLayout className="m-0 flex flex-1 flex-col gap-4 rounded-md bg-white p-4">
          ...
          <div className="relative flex flex-col w-full cursor-text overflow-y-auto rounded-md bg-slate-50 p-2 outline-none outline outline-2 hover:bg-slate-100">
